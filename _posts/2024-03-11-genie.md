...
excerpt: "구글 딥마인드의 Foundation Wolrd Model, Genie 논문을 리뷰합니다."
...
Genie의 3 가지 핵심 컴포넌트를 살펴보기에 앞서, 먼저 ST-transformer 아키텍처에 대해 알아야합니다. Genie의 모든 컴포넌트가 이 아키텍처를 채택했기 때문입니다. 
