...
**Robotics-trained Model:** 로보틱스 데이터셋으로 훈련한 모델에서는 텍스트나 액션 레이블 없이도 Distinct and Consistent 액션을 잘 학습한 모습을 보입니다. 로봇 팔에 대한 컨트롤 뿐만 아니라, 다양한 오브젝트에 대한 Interaction 및 Deformation도 학습한 모습을 볼 수 있습니다. 언젠가는 Genie가 Generalist Agents를 훈련하는 Foundation World Model이 될 수 있을 것 같습니다. 
...
쓰다보니 조금 길고 어려운 글이 되었네요. 여기서 마무리 하겠습니다. 읽어주셔서 감사합니다!