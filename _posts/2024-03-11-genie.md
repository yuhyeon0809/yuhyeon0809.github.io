...
[ST-transformer](https://arxiv.org/pdf/2001.02908.pdf)는 Spatial-Temporal Transformer의 약자로, 공간적(Spatial) 정보와 시간적(Temporal) 정보를 함께 처리할 수 있는 트랜스포머 기반 모델입니다. 

<img width="505" alt="ST-transformer" src="https://github.com/yuhyeon0809/yuhyeon0809/assets/98225529/cb6a3e41-a9d4-4d4f-8d11-f999e516b487">
...
이미지 처리에 많이 쓰이는 [ViT(Vision Transformer)](https://arxiv.org/abs/2010.11929)와 달리 Temporal 레이어가 있어 비디오 데이터 연산에 더욱 효과적인데요. Genie가 ST-transformer를 채택한 이유 역시 이로부터 오는 **메모리 효율성** 때문입니다. 
...
반면 ST-transformer는 연산 복잡도의 지배적 요인인 Spatial Layer의 수가 프레임 수에 비례해 선형적으로 증가하기 때문에 인터랙션이 증가해도 일관성을 유지하는 효율적인 비디오 생성이 가능한 것입니다. 
